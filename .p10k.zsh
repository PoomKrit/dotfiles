# Generated by Powerlevel10k configuration wizard on 2024-12-30 at 20:20 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique # options: truncate_to_unique , truncate_to_last , truncate_middle , truncate_from_right , truncate_with_package_name , truncate_absolute Replace removed segment suffixes with this symbol.
