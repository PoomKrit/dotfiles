...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last # options: truncate_to_unique , truncate_to_last , truncate_middle , truncate_from_right , truncate_with_package_name , truncate_absolute
